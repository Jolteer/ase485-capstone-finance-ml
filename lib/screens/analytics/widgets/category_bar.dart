/// One row in the analytics category breakdown.
///
/// Displays the category label, a proportional progress bar (coloured per
/// category for instant identification), and the absolute amount.
library;
...
class CategoryBar extends StatelessWidget {
  /// Pre-computed breakdown row (category name, amount, ratio).
